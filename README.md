...
After you've signed off on the design, your agent puts together an implementation plan that's clear enough for an enthusiastic junior engineer with poor taste, no judgement, no project context, and an aversion to testing to follow. It emphasizes clear verification, YAGNI (You Aren't Gonna Need It), and DRY.
...
5. **test-driven-development** - Activates for bug fixes and regressions. Reproduce the failure, prove the regression catches it, make the smallest fix, and verify it passes.
...
**Testing**
- **test-driven-development** - Bug-fix regression workflow (includes testing anti-patterns reference)
...
- **Verification-first development** - Prove claims with fresh evidence; use TDD for bug fixes
